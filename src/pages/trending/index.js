    ...
    <div>
      <div className="flex justify-center items-center mt-24">
        <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
          ...
          >
            <h1 className="text-4xl font-semibold leading-9 text-center text-gray-800 :-gray-50">
              This Week Trending Blogs
            </h1>
            <p className="text-base leading-normal text-center text-gray-600 :-white mt-4 lg:w-1/2 md:w-10/12 w-11/12">

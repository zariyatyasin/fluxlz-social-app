    ...
    <div>
      <div className="bg-white rounded-lg  pb-8">
        <div className="absolute right-12 mt-4 rounded">
          <button className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20">
            <svg
              className="h-4 w-4"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <div className="bg-white absolute hidden right-0 w-40 py-2 mt-1 border border-gray-200 -2xl">
